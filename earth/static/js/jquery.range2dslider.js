...
!function($){
    ...
    var	recalcLabelPosition = function( $label ){
            switch( true ){
                case ($label.hasClass('xdsoft_slider_label_top') || $label.hasClass('xdsoft_slider_label_bottom')):
                    $label.css('margin-left','-'+parseInt($label[0].offsetWidth/2 - 2)+'px');
                    break;
    ...
    updateSliderRanges = function ( _this,ranges ){
        ...
        setValue = function ( _this,sliderId,relX,relY,nochange ){
            ...
            $(_this.$sliderLeft).css('width',Math.round(pos[0])) ;
        ...
        var drag = false,
            ...
            xdSoftDraggableDrag = function( event ){
                if( drag&&!options.disabled ){
                    ...
                    $(draggableElement).siblings('.sliderLeft').css('width',newX);
        ...
        if( typeof(_options)=='string' ){
            ...
            return this.each(function(){
                ...
                for(i=0;i<_this.values.length;i++){
                    if( !_this.$runners[i] ){
                        _this.$runners.push($runner = $('<div class="xdsoft_range2dslider_runner xdsoft_range2dslider_runner'+i+'"><div style="text-align:center;line-height:24px;">N</div></div>'));
                ...
                _this.$sliderLeft = $('<div class="sliderLeft" ></div>');
                ...
                .append(_this.$sliderLeft);


                // var rangee = _this.options.axis[0];
                // var lengthrange = rangee[rangee.length-1]-rangee[0];
                // var count = 385/lengthrange;
                // var obj=null;
                //
                //
                // for(i=1;i<lengthrange;i++){
                //  obj = $('<span class="rangee" style="left:'+parseInt(count*i+2)+'px;"></span>');
                //  _this.$sliderBox.append(obj);
                // }
